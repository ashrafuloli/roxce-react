...
const ServicesHomeTwo = () => {
    return (
        <>
            <section className="services__area p-relative z-index-1 pt-130 pb-555">
                <div className="services__bg" style={{backgroundImage: `url(${images.servicesBg2})`}}></div>
                <div className="container">
                    <div className="row">
                        <div className="col-xxl-8 offset-xxl-2 col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                            <div className="section__title-wrapper mb-80 text-center">
                                <span
                                    className="section__title-pre section__title-pre-white center">What We Offer</span>
                    ...
                    <div className="row">
                        <div className="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                            <div className="services__item services__item-2 p-relative mb-30">
                                <div className="services__thumb w-img">
                                    <img src={images.services1} alt="service"/>
                                </div>
                                <div className="services__content services__content-2 text-center">
                                    <div className="services__icon services__icon-2">
