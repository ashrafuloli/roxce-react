            ...
            <footer>
                <div className="footer__area black-bg">
                        ...
                        <div className="container">
                            ...
                            <div className="row">
                                ...
                                <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                    <div className="footer__widget footer__pl-55 mb-50">
                                        <div className="footer__widget-top">
                                ...
                                <div className="col-xxl-4 col-xl-4 col-lg-5 col-md-6 col-sm-6">
                                    <div className="footer__widget footer__pl-50 footer__pr-50 mb-50">
                                        <div className="footer__widget-top">
                                            <h3 className="footer__widget-title">Recent News</h3>
                                        </div>
                                        <div className="footer__widget-content ">
                                                ...
                                                <ul>
                                                        ...
                                                        <div className="footer__blog-sm d-flex align-items-start">
                                                            <div className="footer__blog-sm-thumb mr-20">
                                                                <a href="blog-details.html">
                                                                    <img src={images.footerSm1} alt="footer"/>
                                                                </a>
                                                            </div>
                                                            <div className="footer__blog-sm-content">
                                                                <h3 className="footer__blog-sm-title">
                                                                    <a href="blog-details.html">
                                                                        Impleme Dark Mode In React Apps Using
                                                                    </a>
                                                                </h3>
                                                                <div className="footer__blog-sm-meta">
                                                                    <span>
                                                                        <i className="far fa-calendar-alt"/> 25 nov 2021
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div className="footer__blog-sm d-flex align-items-start">
                                                            <div className="footer__blog-sm-thumb mr-20">
                                                                <a href="blog-details.html">
                                                                    <img src={images.footerSm2} alt="footer"/>
                                                                </a>
                                                            </div>
                                                            <div className="footer__blog-sm-content">
                                                                <h3 className="footer__blog-sm-title">
                                                                    <a href="blog-details.html">
                                                                        Django Highlige Models Admin And Harnesse
                                                                    </a>
                                                                </h3>
                                                                <div className="footer__blog-sm-meta">
                                                                    <span>
                    ...
                    <div className="footer__bottom">
                        <div className="container">
                            <div className="footer__bottom-border footer__bottom-border-2">
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-8">
                                        <div
                                            className="footer__copyright footer__copyright-2 d-sm-flex align-items-center justify-content-md-end">
